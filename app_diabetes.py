...
if (selected == "Parkinsons Prediction"):
    ...
    parkinson_model= joblib.load('Parkinson_model.pklsss')
    ...
    with col1:
       MDVP_jitter = st.number_input('MDVP:Jitter(%)', min_value=0.001, max_value=0.000100, value=0.0078)
    with col2:
    ...
    with col1:
        MDVP_Shimmer_db = st.number_input('MDVP:Shimmer(dB)', min_value=0.01, max_value=0.1000, value=0.246)
    with col2:
        Shimmer_Apq3 = st.number_input('Shimmer:APQ3', min_value=0.001, max_value=0.01000, value=0.0152)
    with col3:
        Shimmer_Apq5= st.number_input('Shimmer:APQ5', min_value=0.001, max_value=0.01000, value=0.4321)
    with col1:
        MDVP_Apq = st.number_input('MDVP:APQ', min_value=0.001, max_value=0.01000, value=0.0359)
    with col2:
        Shimmer_DDA = st.number_input('Shimmer:DDA', min_value=0.001, max_value=0.01000, value=0.0349)
    with col3:
